...
// string format: apiVersion-<apiVersion>/namespace-<namespace>/kind-<kind>/name-<name>/ephemeralContainerName-<containerName>
const (
	prefixEphemeralContainer = "ephemeralContainerName-"
	stringFormat             = helpers.PrefixApiVersion + "%s" + helpers.StringFormatSeparator + helpers.PrefixNamespace + "%s" + helpers.StringFormatSeparator + helpers.PrefixKind + "%s" + helpers.StringFormatSeparator + helpers.PrefixName + "%s" + helpers.StringFormatSeparator + prefixEphemeralContainer + "%s"
)

const InstanceType helpers.InstanceType = "ephemeralContainer"
...
func (id *InstanceID) GetContainerName() string {
	return id.ephemeralContainerName
}
...
func (id *InstanceID) SetContainerName(ephemeralContainerName string) {
	id.ephemeralContainerName = ephemeralContainerName
}
...
func (id *InstanceID) GetLabels() map[string]string {
	...
	return map[string]string{
		...
		helpers.EphemeralContainerNameMetadataKey: id.GetContainerName(),
	}
}
