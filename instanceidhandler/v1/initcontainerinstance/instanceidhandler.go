...
// string format: apiVersion-<apiVersion>/namespace-<namespace>/kind-<kind>/name-<name>/initContainerName-<containerName>
const (
	prefixInitContainer = "initContainerName-"
...
func (id *InstanceID) SetContainerName(initContainerName string) {
	id.initContainerName = initContainerName
}
...
func (id *InstanceID) GetLabels() map[string]string {
	...
	return map[string]string{
		...
		helpers.InitContainerNameMetadataKey: id.GetContainerName(),
	}
}
