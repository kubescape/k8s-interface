...
func TestInitInstanceID(t *testing.T) {
	...
	insFromString, err := GenerateInstanceIDFromString("apiVersion-v1/namespace-default/kind-Pod/name-nginx/initContainerName-nginx") //insFromWorkload[0].GetStringFormatted())
	if err != nil {
...
func TestGenerateInstanceIDFromString(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				input: "apiVersion-v1/namespace-default/kind-Pod/name-nginx/initContainerName-nginx",
			},
			want: &InstanceID{
				apiVersion:        "v1",
				namespace:         "default",
		...
		},
		{
			...
			args: args{
				input: "apiVersion-apps/v1/namespace-default/kind-ReplicaSet/name-nginx-1234/initContainerName-nginx",
			},
			want: &InstanceID{
				apiVersion:        "apps/v1",
				namespace:         "default",
